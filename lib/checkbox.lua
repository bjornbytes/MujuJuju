...
function Checkbox:update()
  ...
  self.scale = lume.lerp(self.scale, hover and 1.15 or 1, math.min(16 * ls.tickrate, 1))

  self.factor = lume.lerp(self.factor, self.value and 1 or 0, math.min(16 * ls.tickrate, 1))
