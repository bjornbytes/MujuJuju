...
function Wave:update()
  ...
  local ratio = love.graphics.getWidth() / love.graphics.getHeight()
	self.strength[1] = lume.lerp(self.strength[1], p.dead and .0025 or 0, 3 * ls.tickrate)
	self.strength[2] = lume.lerp(self.strength[2], p.dead and (.0025 * ratio) or 0, 3 * ls.tickrate)
